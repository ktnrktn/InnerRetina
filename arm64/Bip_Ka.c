...
#define m_exp _p[6]
#define m_exp_columnindex 6
#define h_exp _p[7]
#define h_exp_columnindex 7
#define m _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 IA /Users/kitano/Desktop/retina/mod/Bip_Ka.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 49 in file Bip_Ka.mod:\n SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/Bip_Ka.mod";
static const char* nmodl_file_text = 
