...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "h_inf_HHna", _hoc_h_inf,
 "m_inf_HHna", _hoc_m_inf,
 "rates_HHna", _hoc_rates,
 0, 0
};
#define h_inf h_inf_HHna
#define m_inf m_inf_HHna
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 HHna /Users/kitano/Desktop/retina/mod/A2hh_na.mod\n");
...
/*CVODE*/
 ...
 {
   rates ( _threadargscomma_ v ) ;
    m = m + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / 0.01)))*(- ( ( ( minf ) ) / 0.01 ) / ( ( ( ( - 1.0 ) ) ) / 0.01 ) - m) ;
    h = h + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / 0.5)))*(- ( ( ( hinf ) ) / 0.5 ) / ( ( ( ( - 1.0 ) ) ) / 0.5 ) - h) ;
   }
  return 0;
}
...
double m_inf (  double _lv ) {
   double _lm_inf;
 _lm_inf = 1.0 / ( 1.0 + exp ( - ( _lv + 48.0 ) / 5.0 ) ) ;
...
double h_inf (  double _lv ) {
   double _lh_inf;
 _lh_inf = 1.0 / ( 1.0 + exp ( ( _lv + 49.5 ) / 2.0 ) ) ;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 40 in file A2hh_na.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/A2hh_na.mod";
static const char* nmodl_file_text = 
