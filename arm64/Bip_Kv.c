...
#define tau_m1 _p[1]
#define tau_m1_columnindex 1
#define tau_h1 _p[2]
#define tau_h1_columnindex 2
#define ikv _p[3]
#define ikv_columnindex 3
#define m_inf _p[4]
...
#define m_exp _p[8]
#define m_exp_columnindex 8
#define h_exp _p[9]
#define h_exp_columnindex 9
#define m _p[10]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 IKv /Users/kitano/Desktop/retina/mod/Bip_Kv.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 51 in file Bip_Kv.mod:\n SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/Bip_Kv.mod";
static const char* nmodl_file_text = 
