...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ih /Users/kitano/Desktop/retina/mod/Bip_ih.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ih = ghbar * ( 1.0 - ( 1.0 + 3.0 * n ) * pow( ( 1.0 - n ) , 3.0 ) ) * ( v - eh ) ;
   }
 _current += ih;
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 40 in file Bip_ih.mod:\n SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/Bip_ih.mod";
static const char* nmodl_file_text = 
  "TITLE Ih\n"
