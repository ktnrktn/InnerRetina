...
#define nrn_init _nrn_init__IinjLT_oncbc
#define _nrn_initial _nrn_initial__IinjLT_oncbc
#define nrn_cur _nrn_cur__IinjLT_oncbc
#define _nrn_current _nrn_current__IinjLT_oncbc
#define nrn_jacob _nrn_jacob__IinjLT_oncbc
#define nrn_state _nrn_state__IinjLT_oncbc
#define _net_receive _net_receive__IinjLT_oncbc 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IinjLT_oncbc /Users/kitano/Desktop/retina/mod/IinjLT_oncbc.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ...
   if ( t > 2000.0  && t < 3000.0 ) {
     i = amp * 0.0028 * log ( 2.0 * t - 3999.0 ) + 0.001 * ssI ;
     }
   if ( t >= 3000.0 ) {
     i = amp * 1.0 / ( 1.5 * t - 4450.0 ) + 0.001 * ssI ;
     }
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/IinjLT_oncbc.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "  IinjLT.mod\n"
  ...
  "\n"
  "	if(t>2000 && t<3000){\n"
  "	i = amp*0.0028*log(2*t-3999) + 0.001*ssI\n"
  "	}\n"
  "\n"
  "	if(t>=3000){\n"
  "		i = amp*1.0 / (1.5*t-4450) + 0.001*ssI\n"
  "	}\n"
  "}\n"
  "\n"
  "NET_RECEIVE (w) {\n"
