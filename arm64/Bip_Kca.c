...
#define gkcabar _p[0]
#define gkcabar_columnindex 0
#define ikca _p[1]
#define ikca_columnindex 1
#define m_inf _p[2]
#define m_inf_columnindex 2
#define tau_m _p[3]
#define tau_m_columnindex 3
#define m_exp _p[4]
#define m_exp_columnindex 4
#define m _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 kca /Users/kitano/Desktop/retina/mod/Bip_Kca.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("kca", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 51 in file Bip_Kca.mod:\n SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/Bip_Kca.mod";
static const char* nmodl_file_text = 
