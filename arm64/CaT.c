...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaT /Users/kitano/Desktop/retina/mod/CaT.mod\n");
...
static int _reset;
static char *modelname = "low-voltage-activated (T-type) calcium channel for STN neuron";
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( - ( _lv + 56.0 ) / 6.7 ) ) ;
   taum = 5.0 + 0.33 / ( exp ( ( _lv + 27.0 ) / 10.0 ) + exp ( - ( _lv + 102.0 ) / 15.0 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 85.0 ) / 5.8 ) ) ;
   tauh = 400.0 / ( exp ( ( _lv + 50.0 ) / 15.0 ) + exp ( - ( _lv + 50.0 ) / 16.0 ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/kitano/Desktop/retina/mod/CaT.mod";
static const char* nmodl_file_text = 
